...
Parameters:
    name: "companies is the name of the blueprint, which Flask’s routing mechanism uses and identifies it in the project.
...
"""
from rest.company import routes
from rest.company.v1.routes import *
