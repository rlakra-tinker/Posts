...
from iws.webapp.routes import bp as webapp_bp
from iws.api import bp as api_bp
from iws.rest import bp as rest_bp
...
class WebApp:
    ...
    def create_app(self, config_class: Config = Config, test_mode: bool = False) -> Flask:
        ...
        # Connect the 'iws' blueprint with other end-points of the project
